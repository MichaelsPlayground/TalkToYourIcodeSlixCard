...
public class DesfireAuthenticateLegacy {
    ...
    public byte[] tripleDesSendModeDecryption(byte[] tdesKeyExt, byte[] ciphertextExt) {
        ...
        byte[] ct1XoredDecrypted = de.androidcrypto.talktoyouricodeslixcard.nfcjlib.TripleDES.decrypt(tdesKey, ct1Xored, 0, 8);
        ...
        byte[] ct2XoredDecrypted = de.androidcrypto.talktoyouricodeslixcard.nfcjlib.TripleDES.decrypt(tdesKey, ct2Xored, 0, 8);
